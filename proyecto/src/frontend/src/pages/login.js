...
export function renderLogin() {
    const loginForm = createElement('section', { className: 'py-3 py-md-5 py-xl-8 min-vh-100', style: { backgroundColor: '#eff4ff' } });
    loginForm.innerHTML = `<div class="container">
      <div class="row gy-4 align-items-center">
        <div class="col-12 col-md-6 col-xl-7">
          <!-- aqui es para el cuadro a la par de login-->
          <div class="d-flex justify-content-center align-items-center h-100" style="
            ...
            <div class="col-12 col-xl-9">
              <h3 class="fw-bold mb-3">Costa Rica needs you every day.</h3>
              <p class="mb-3">
                The CCSS needs between
                <strong>150 and 200 blood donations daily</strong> — and that
                goal is rarely met.
              </p>
              <p class="mb-3">
                One donation can help
                <strong>up to 4 different people</strong> at once.
              </p>
              <p class="mb-3">
                Every week, <strong>2 to 3 open heart surgeries</strong> are
                performed at CCSS hospitals.
              </p>
              <p class="fw-bold">Be one of the few who make it possible.</p>
              <div class="text-endx">
